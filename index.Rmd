...
## **Three main behavioural pathways** (Francis and Barber 2013 *in Frontiers in Ecology and the Environment*)
...
Figure derived from: <a href="https://esajournals.onlinelibrary.wiley.com/doi/full/10.1890/120183">Francis and Barber (2013)</a>
---
...
* ### Reductions in immune response 
* ### Sleep disruptions implicated 


## Direct hearing loss has been documented (Labratory experiments)

---
# Fitness Costs 

## Link between behavioural/phsiological responses and populations 
...
## 2. Are there noise thresholds at which effects increase drastically? 
...
---
# Formal Search Protocol 

## Used literature map from **Sordello et al. (2020) *in Environmental Evidence*** as base 

<br> 

## Updated the Sordello et al. (2020) databse with systematic search using PECO framework (<a href="https://clarivate.com/academia-government/scientific-and-academic-research/research-discovery-and-referencing/web-of-science/">Web of Science</a>)

## Search can be coninually updated 
...
## Hearing range described by audiograms 

<img src="audiogram.png" width="60%" align="middle" />

<a href="https://www.animalaudiograms.org/aboutaudiograms">Figure source: AnimalAudiograms.org</a>
---
# Sound Attenuation 

## dB decreases with distance according to the Inverse Square Law

<img src="sound-attenuation.png" width="60%" align="middle" />

<a href="https://www.enoisecontrol.com/acoustic-terminology/doubling-distance-noise-reduction-decibel/">Figure source: eNoiseControl</a>
...
* ## 33% of species showed negative noise response 
...
* ## Compared mule deer use of natural gas infrastructure areas during drilling (very noisy) and production (much less noisy) phases

* ## Higher use by mule deer during production phase

* ## Strongly suggests noise is the primary factor 
...
.pull-left[
## Research on masking effects (60%)

* ## Changes in calling behaviour (almost entirely)

* ## Some on mate selection 
...
.pull-right[
<img src="figures/herps_plot.png" width="100%" align="middle" />
] 

---
# **Herps found in Canada** 

## Anurans in eastern Ontario (Vargas-Salinas et al. 2014 *in Urban Ecosystems*) 

* ## Variable response in mating call timing 

<br>

## Wood frog response to traffic playback (Tennessen et al. 2014 *in Conservation Physiology*)

* ## Increased cortisol and reduced phonotaxis (ability to find the calling male)
...
.pull-left[
## Only 22 total studies 

* ## Masking effects on mating and territory defense

* ## Disturbance effects on space use and foraging/predator defense
]

.pull-right[
<img src="figures/inverts_plot.png" width="100%" align="middle" />
]

---
# **Invertebrates in Canada** 

## Monarch butterfly larvae (Davis et al. 2018 *in Biology Letters*) 

* ## Stress response to simulated highway noise 

* ## Apparent habituation after 7-12 days 
<br> 

## May impair reactions to real stressors as adults 
...
---
# Threshold Plot (Shannon et al. 2016 *in Biological Reviews*)

<img src="figures/shannon_2016_cumsum_plot.png" width="60%" align="middle" /> 

---
# Cumulative percent of studies with effect at a given noise level 
...
## Guidence from previous table (60-70 dB range)

---
# Vibration Effects on Terrestrial Wildlife 

## **Vibration:** any anthropogenically produced substrate-bourne vibrational signature" 
  * ###(Roberts and Howard 2022 *in Biotremology: Physiology, Ecology, and Evolution*)

<br> 

## Also called 'vibrational noise' 

## Many species (mostly underground dwellers) rely on vibrational cues 
...
## Natural sources 
* ## Rain, waterfalls, large animals, etc... 

## Anthropogenic sources 
* ## Roads, railroads, mining, petroleum 


---
# Likely effects on terrestrial wildlife 

## Inverebrates and subterranian mammals most affected 

* ## Highest exposure 

* ## Reliance on seismic cues 


## Most likely pathway is masking 

---
# Studies at present 

## Garden spiders (Wu and Elias 2014 *in Animal Behaviour*) 

* ## Vibration reduced spider sensitivity to prey cues 

<br> 

## Midwife toad (Caorsi et al. 2019 *in Scientific Reports*)

* ## Vibrations interfered with calling rate 

---
# Research Gaps 

* ## Lack of research on nuclear facilities 

--

* ## Long term studies of multiple responses 
...
* ## Strong bias towards birds and roads (because they are easy) 

--

* ## Research outside of breeding season 

---
# A good first step: Understanding Exposure
--- 

## Exposure = noise footprint + animal hearing capability 

.pull-left[
## Attenuation limits footprint

## Sampling in rings around facilities 

## Mapping the noise footprint

]


.pull-right[
<img src="figures/noise-footprint.png" width="70%" align="middle" /> 

]

---
# 2D Noise Footprint Maps  

.pull-left[
## Example from Alam et al. (2022) *in Frontiers in Sustainability*
<img src="noise-map.png" width="100%" align="middle" /> 
]

.pull-right[
* ## Can create species-specific maps using audiograms
* ## Can overlay on habitat models 
* ## Can explore how mitigations change maps 
]

---
# Using Autonomous Recording Units (ARU) 

--- 
.pull-left[
<img src="wildtrax.png" width="80%" align="middle" /> 
* ### Designed for wildlife 
* ### Need calibration protocol to convert to SPL measurements

]

.pull-right[
<img src="aru.png" width="100%" align="middle" /> 

] 

---
# Creating a calibration protocol
## Pair ARUs with SPL meter

.center[
<img src="spl-array.png" width="70%" align="middle" /> 
...
# Conclusions 
--- 
## We know noise effects wildlife in many different ways 

<br> 

## Translating knowledge to conservation is key 

* ## Mapping noise footprint 
* ## Incorporating species audiograms 

## Noise thresholds of 60-70 dB offer guidance 
